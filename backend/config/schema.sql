-- ================================================================
-- NOH Hospital - Unified Database Schema
-- Bệnh viện Tai Mũi Họng Trung ương
-- ================================================================
-- Gộp từ:
--   • noh-hospital/backend/config/schema.sql     (public website)
--   • noh-admin/backend/config/schema_update.sql  (admin system)
-- ================================================================
-- Cách chạy:
...
-- Gộp cột từ cả 2 schema: cột gốc + cột mở rộng admin
CREATE TABLE IF NOT EXISTS appointments (
  id INT PRIMARY KEY AUTO_INCREMENT,
  -- Thông tin đặt lịch (public website)
  full_name VARCHAR(200) NOT NULL,
